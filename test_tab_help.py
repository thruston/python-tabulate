...
noblanks nospace pivot pop push roll rule sf shuffle sort tap uniq
unwrap unzip wrap xp zip
'''.strip()
        self.verbs = '''
...
pow reversed round secs si sin sind sorted sqrt sum tan tand tau
'''.strip()
